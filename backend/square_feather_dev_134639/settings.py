"""
Django settings for square_feather_dev_134639 project.
...
ROOT_URLCONF = 'square_feather_dev_134639.urls'
...
WSGI_APPLICATION = 'square_feather_dev_134639.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_feather_dev_134639 API",
    "DESCRIPTION": "API documentation for square_feather_dev_134639 App",
    "VERSION": "v1",
}
